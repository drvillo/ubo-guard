      ...
      <div className="mx-auto max-w-4xl px-4 py-8">
        <div className="mb-8 rounded-lg bg-white p-8 shadow-lg dark:bg-zinc-900">
          ...
          {linkInfo.purposeNotes && (
            <p className="text-zinc-600 dark:text-zinc-400">{linkInfo.purposeNotes}</p>
          )}
        </div>
        ...
        {!otpVerified && (
          <div className="rounded-lg bg-white p-8 shadow-lg dark:bg-zinc-900">
            <OtpForm token={token} onVerified={handleOtpVerified} />
          </div>
        )}

        {otpVerified && !lsk && linkInfo.encryptedLskForVendor && linkInfo.lskSalt && linkInfo.lskNonce && (
          <div className="mt-8 rounded-lg bg-white p-8 shadow-lg dark:bg-zinc-900">
            <SecretForm
